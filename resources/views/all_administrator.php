	...
	<div class="page-container">
		...
		<div class="page-content-wrapper">
			<div class="page-content">
				<div class="page-bar">
					<div class="page-title-breadcrumb">
						<div class=" pull-left">
							<div class="page-title">All Administrator Lists</div>
						</div>
					...
					<div class="col-md-12 col-sm-12">
						<div class="card  card-box">
							<div class="card-head">
								...
								<a href="add_administrator.php" class="btn btn-success p-1">Add Administrator</a>
							</div>
							<div class="card-body ">
								<div class="table-wrap">
									<div class="table-responsive">
										<table class="table display product-overview mb-30" id="support_table">
											...
											<tbody>
												<?php
												// Fetch all administrator records from the database
			...
			<div class="modal-container">
				<div class="modal fade" id="viewAdministrator" tabindex="-1" aria-labelledby="exampleModalLabel" aria-modal="true">
					<div class="modal-dialog modal-dialog-centered">
						<div class="modal-content">
							<div class="modal-header">
								<h5 class="modal-title" id="exampleModalLabel">View Administrator Details</h5>
							</div>
...
<script src="../js/adminstrator-function.js"></script>